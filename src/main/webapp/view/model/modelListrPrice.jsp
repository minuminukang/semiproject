...
<section id="content">
        ...
        <div class="paging">
        	<button onclick="location.href='<%= request.getContextPath() %>/model/view/modelListrPrice?page=1'">&lt;&lt;</button>
			
			<!-- 이전 페이지로 -->
			<button onclick="location.href='<%= request.getContextPath() %>/model/view/modelListrPrice?page=<%= pageInfo.getPrvePage() %>'">&lt;</button>
			...
			<% for (int p = pageInfo.getStartPage(); p <= pageInfo.getEndPage(); p++) { %>
				...
				<% } else { %>
					<button onclick="location.href='<%= request.getContextPath() %>/model/view/modelListrPrice?page=<%= p %>'"><%= p %></button>
				<% } %>
			<% } %>
			
			<!-- 다음 페이지로 -->
			<button onclick="location.href='<%= request.getContextPath() %>/model/view/modelListrPrice?page=<%= pageInfo.getNextPage()%>'">&gt;</button>
			
			<!-- 맨 끝으로 -->
			<button onclick="location.href='<%= request.getContextPath() %>/model/view/modelListrPrice?page=<%= pageInfo.getMaxPage() %>'">&gt;&gt;</button>
        </div>
</section>
    </div>
    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <h4 id="car-manu" class="car-manu">[<%=model.getNation() %>] > [<%=model.getCompany() %>]</h4>
                            ...
                            <div class="d-grid mb-4">
                                <button type="button" class="btn btn-primary btntransition form-btn" style="height: 50px; width: 100%;" 
